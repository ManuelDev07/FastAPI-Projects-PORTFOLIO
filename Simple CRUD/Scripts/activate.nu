...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\MBayo\Documents\Programación\Prácticas\Python\Proyectos FastAPI\P1\P1-FastAPI'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\MBayo\Documents\Programación\Prácticas\Python\Proyectos FastAPI\P1\P1-FastAPI\Scripts\deactivate.nu'
